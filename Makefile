...
LISP_DIR=./lisp
MAIN_EL=$(LISP_DIR)/casual-ibuffer.el
VERSION_EL=$(LISP_DIR)/casual-ibuffer-version.el
...
bump-casual:
	...
	sed -i 's/(defconst casual-ibuffer-version "$(VERSION)"/(defconst casual-ibuffer-version "$(VERSION_BUMP)"/' $(VERSION_EL)
...
new-sprint: sync-development-with-main
	...
	sed -i 's/(defconst casual-ibuffer-version "$(VERSION)"/(defconst casual-ibuffer-version "$(VERSION_PRERELEASE)"/' $(MAIN_EL)
